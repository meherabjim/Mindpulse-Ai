...
const reportPdfRoutes = require('./routes/reportPdf.routes');
...
const recommendationSessionRoutes = require('./routes/recommendationSession.routes');
...
app.use('/api/v1', adminContentRoutes);
...
app.use('/api/v1', recommendationSessionRoutes);
